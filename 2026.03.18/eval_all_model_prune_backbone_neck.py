...
用法：
    ...
    python ./univ2x_purned/eval_all_model_prune_backbone_neck.py \
        ...
        ./univ2x_purned/modelopt/all_model_prune_backbone_neck_byclaude/output/all_model_prune_bb_neck_pruned_model_20260316_163558.pth \
        --gpu-id 1 \
        --eval bbox
"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="推理时启用的模型任务头（默认只 det，与剪枝 score_func 对齐）。"
...
def main():
    ...
    #   使用 cfg.data.test 的副本（避免原地修改影响后续逻辑）
    # ================================================================
    ...
    # ---- ret_iou 补丁（与剪枝 score_func / verify 脚本一致） ----
